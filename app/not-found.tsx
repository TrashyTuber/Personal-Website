...
export default function NotFound() {
  return (
    <div className="mx-auto min-h-[60vh] max-w-xl px-6 py-16 text-center">
      ...
      <h1 className="mt-2 text-2xl font-light">Page not found</h1>
      ...
      <p className="mt-10">
        <Link
          href="/"
          className="font-mono-game text-xs text-vermilion-text transition-colors hover:text-paper focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-vermilion"
        >
